...
export interface HumanAgentINFTInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "transferWithProof",
...
export namespace MetadataUpdatedEvent {
  ...
  export type OutputTuple = [tokenId: bigint, newHash: string, newURI: string];
  export interface OutputObject {
    tokenId: bigint;
    newHash: string;
    newURI: string;
...
export interface HumanAgentINFT extends BaseContract {
  ...
  transferWithProof: TypedContractMethod<
    [
      from: AddressLike,
      to: AddressLike,
      tokenId: BigNumberish,
  ...
  getFunction(
    nameOrSignature: "transferWithProof"
  ): TypedContractMethod<
    [
      from: AddressLike,
      to: AddressLike,
  ...
  filters: {
    ...
    "MetadataUpdated(uint256,bytes32,string)": TypedContractEvent<
      MetadataUpdatedEvent.InputTuple,
      MetadataUpdatedEvent.OutputTuple,
      MetadataUpdatedEvent.OutputObject
    >;
