...
export interface HumanAgentINFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "authorizeUsage"
...
export interface HumanAgentINFT extends BaseContract {
  connect(runner?: ContractRunner | null): HumanAgentINFT;
  waitForDeployment(): Promise<this>;

  interface: HumanAgentINFTInterface;
  ...
  authorizeUsage: TypedContractMethod<
    [tokenId: BigNumberish, executor: AddressLike, allowed: boolean],
    [void],
    "nonpayable"
  >;
  ...
  filters: {
    ...
    "Minted(uint256,address,string,bytes32)": TypedContractEvent<
      MintedEvent.InputTuple,
      MintedEvent.OutputTuple,
      MintedEvent.OutputObject
    >;
    ...
    "UsageAuthorized(uint256,address,bool)": TypedContractEvent<
      UsageAuthorizedEvent.InputTuple,
      UsageAuthorizedEvent.OutputTuple,
      UsageAuthorizedEvent.OutputObject
    >;
