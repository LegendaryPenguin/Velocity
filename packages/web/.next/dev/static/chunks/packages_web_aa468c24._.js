...
"[project]/packages/web/components/builders/InferenceVisualDiagram.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
_c = InferenceVisualDiagram;
var _c;
__turbopack_context__.k.register(_c, "InferenceVisualDiagram");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
"[project]/packages/web/app/modules/inference-builder/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$web$2f$components$2f$builders$2f$InferenceVisualDiagram$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/web/components/builders/InferenceVisualDiagram.tsx [app-client] (ecmascript)");
...
function InferenceBuilderPage() {
    _s();
    const [interfaceChoice, setInterfaceChoice] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("webui");
    const installSnippet = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "InferenceBuilderPage.useMemo[installSnippet]": ()=>`# Install CLI (Node >= 22.0.0 required)
pnpm add @0glabs/0g-serving-broker -g`
    }["InferenceBuilderPage.useMemo[installSnippet]"], []);
    const webUISnippet = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "InferenceBuilderPage.useMemo[webUISnippet]": ()=>`# Launch Web UI locally
...
0g-compute-cli ui start-web --port 3091`
    }["InferenceBuilderPage.useMemo[webUISnippet]"], []);
    const depositSnippet = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "InferenceBuilderPage.useMemo[depositSnippet]": ()=>`# Deposit to main account
...
0g-compute-cli transfer-fund --provider <PROVIDER_ADDRESS> --amount 5`
    }["InferenceBuilderPage.useMemo[depositSnippet]"], []);
    const acknowledgeSnippet = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "InferenceBuilderPage.useMemo[acknowledgeSnippet]": ()=>`# Acknowledge provider before using
0g-compute-cli inference acknowledge-provider --provider <PROVIDER_ADDRESS>`
    }["InferenceBuilderPage.useMemo[acknowledgeSnippet]"], []);
    const checkBalanceSnippet = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "InferenceBuilderPage.useMemo[checkBalanceSnippet]": ()=>`# Check account balance
0g-compute-cli get-account

# View sub-account for a provider
0g-compute-cli get-sub-account --provider <PROVIDER_ADDRESS>`
    }["InferenceBuilderPage.useMemo[checkBalanceSnippet]"], []);
    const sdkInstallSnippet = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "InferenceBuilderPage.useMemo[sdkInstallSnippet]": ()=>`# Install SDK
pnpm add @0glabs/0g-serving-broker`
    }["InferenceBuilderPage.useMemo[sdkInstallSnippet]"], []);
    const sdkDepositSnippet = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "InferenceBuilderPage.useMemo[sdkDepositSnippet]": ()=>`// Deposit to main account
...
await broker.ledger.transferFund(providerAddress, amount);`
    }["InferenceBuilderPage.useMemo[sdkDepositSnippet]"], []);
    const sdkAcknowledgeSnippet = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "InferenceBuilderPage.useMemo[sdkAcknowledgeSnippet]": ()=>`// Acknowledge provider before first use
await broker.inference.acknowledgeProviderSigner(providerAddress);`
    }["InferenceBuilderPage.useMemo[sdkAcknowledgeSnippet]"], []);
    const sdkBasicSnippet = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "InferenceBuilderPage.useMemo[sdkBasicSnippet]": ()=>`// Initialize broker (Node >= 22)
...
// Then use ledger, inference APIs for direct API access`
    }["InferenceBuilderPage.useMemo[sdkBasicSnippet]"], []);
    const addToProjectSteps = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "InferenceBuilderPage.useMemo[addToProjectSteps]": ()=>[
                {
                    num: 1,
                    title: "Install CLI",
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$web$2f$components$2f$builders$2f$InferenceVisualDiagram$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["InferenceVisualDiagram"], {}, void 0, false, {
                fileName: "[project]/packages/web/app/modules/inference-builder/page.tsx",
                lineNumber: 133,
                columnNumber: 7
            }, this),
            ...
            interfaceChoice === "webui" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                className: "glass-card rounded-2xl p-5",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                        className: "text-lg font-semibold text-white/90",
            ...
            interfaceChoice === "cli" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                className: "glass-card rounded-2xl p-5",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                        className: "text-lg font-semibold text-white/90",
            ...
            interfaceChoice === "sdk" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                className: "glass-card rounded-2xl p-5",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                        className: "text-lg font-semibold text-white/90",
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                ...
                children: [
                    ...
                    (interfaceChoice === "cli" || interfaceChoice === "webui") && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(InferenceBuilderPage, "rKQUQoww+Al0ELG4dbsi8ZgpPQ4=");
_c = InferenceBuilderPage;
var _c;
__turbopack_context__.k.register(_c, "InferenceBuilderPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=packages_web_aa468c24._.js.map