...
function CaptchaBuilderPage() {
    ...
    const snippet = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CaptchaBuilderPage.useMemo[snippet]": ()=>`import { CaptchaModal } from "@ogtrust/web";

export function VerifyButton() {
  const [open, setOpen] = useState(false);

  const onVerified = (payload, score) => {
    // ZK proof + validation flow
    setOpen(false);
  };

  return (
    <>
      <button onClick={() => setOpen(true)}>Verify Access</button>
      <CaptchaModal
        isOpen={open}
        onClose={() => setOpen(false)}
        onVerifiedHuman={onVerified}
        theme="${theme}"
        gridSize={${gridSize}}
      />
    </>
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "mt-1 text-sm text-white/60",
                        children: "Get an importable captcha component with tile puzzle + behavioral model."
                    }, void 0, false, {
                        fileName: "[project]/packages/web/app/modules/captcha-builder/page.tsx",
                        lineNumber: 48,
                        columnNumber: 9
                ...
                steps: [
                    {
                        ...
                        body: "npm install @ogtrust/web"
                    },
                    {
                        num: 2,
                        title: "Import and use",
                        body: "Add CaptchaModal to your flow and handle onVerifiedHuman."
                    },
                    {
                        num: 3,
                        title: "Wire ZK proof",
                        body: "Use generateProof + submitProofForValidation from lib/zk/prove."
                    }
                ]
            }, void 0, false, {
                fileName: "[project]/packages/web/app/modules/captcha-builder/page.tsx",
...
_s(CaptchaBuilderPage, "ktL5dRTk+C3Tx+qQAZfhUy6NxoU=");
...
//# sourceMappingURL=packages_web_abaaa85b._.js.map